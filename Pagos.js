      ...
      if (datos.hermanos && datos.hermanos.length > 0) {
        ...
        datos.hermanos.forEach(hermano => {
          try {
            ...
            // El 'hermano.tipo' viene desde la validación en 'validarDNIHermano'.
            ...
            const datosHermano = {
              ...
              tipoInscripcionOriginal: tipoInscripcionHermano, // (NUEVO) Guardamos el tipo real del hermano
              esPreventa: tipoInscripcionHermano === 'preventa', // 'esPreventa' es true SOLO si el hermano es de preventa
            ...
            if (respHermano.status === 'OK_REGISTRO') {
              hermanosRegistrados.push({
                ...
                apellido: hermano.apellido,
                dni: hermano.dni,
                tipo: "hermano/a" // Usar un tipo genérico
              });
            } else {
